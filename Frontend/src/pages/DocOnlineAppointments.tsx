...
import { CalendarClock, Clock4,  HomeIcon,  Info, LayoutDashboard,    PhoneIncoming,    UserCircle } from 'lucide-react';
import { Doc_All_Online_appointments } from "../components/Doc_All_Online_Appointments";
...
export const DocOnlineAppointments=()=>{
    ...
    return <div className="flex justify-center align-middle">
        <Sidebar name={docIntro.name} email={docIntro.email}>
            ...
            <SidebarItem icon = {<PhoneIncoming size={20} />} text ='Online Appointments' active path="/doc/online/appointments" />
