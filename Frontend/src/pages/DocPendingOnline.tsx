...
import { Doc_Online_appointments } from "../components/Doc_Online_appointments";
...
export const DocPendingOnline=()=>{
    ...
    <Sidebar name={docIntro.name} email={docIntro.email}>
            ...
            <SidebarItem icon = {<Info size={20} />} text ='Pending Online' active  path="/doc/pending/online"/>
        </Sidebar>
    <Doc_Online_appointments />
    </div>
}