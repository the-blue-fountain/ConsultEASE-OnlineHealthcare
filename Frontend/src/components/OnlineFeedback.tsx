...
export const FeedbackOnlineForm=({appointmentid}:{appointmentid:string})=>{
    ...
    const handledocRating=async()=>{
        try{
          ...
          await axios.post(`${BACKEND_URL}/api/v1/patient/book/online/appointments/${appointmentid}`,{
            rating:rating
          },{
            headers:{
    ...
    const handleSubmit = async(e: { preventDefault: () => void; }) => {
        ...
        try{
          ...
          const response=await axios.post(`${BACKEND_URL}/api/v1/patient/book/online/feedback/${appointmentid}`,{
        ...
        handledocRating();
        navigate('/pat/online_appointments');
    };
    return (
